...
function LatestJobsTitle(){
    return (
        <>

            <div className="flex relative gap-2.5 justify-between w-full font-semibold max-md:flex-wrap max-md:max-w-full">
...
export default LatestJobsTitle;